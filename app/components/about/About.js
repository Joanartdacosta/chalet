  ...
  return (
    <div>
      <div>
        ...
        <p className="font-text font-size-08 font-italic text-center padding-bottom-1-25">
          Mariana Batista Ramadas
        </p>
        <p className="font-text font-size-11 text-center padding-bottom-1-25">
      ...
      <div>
        <div className="wrap-section display-flex justify-center padding-bottom-1-25">
          ...
          <div className="padding-top-1-25 max-width-55 padding-1 display-flex flex-column justify-center text-center">
            ...
            <p className="media-font-size-11">
              ...
              aconteceu! Adorei todo aquele pocesso de remodelação e decoração
            ...
            <p className="media-font-size-11">
              ...
              começado a pensar em procurar formação nesta área, contando com
