import DesignerPhotos from "./DesignerPhotos";
  ...
  return (
    <div className="text-center margin-auto max-width">
      <div className="padding-top-section">
        ...
        <p className="font-text font-italic padding-bottom-element">
          Mariana Batista Ramadas
        </p>
      </div>

      <div className="padding-top-element padding-bottom-element wrap-section justify-center">
        <DesignerPhotos />
      </div>
      ...
      <div>
        <p className="font-text">
          ...
          detalhe, a sua decoração, quem lá vive? Sim, eu sempre fui essa
          pessoa! <br />
          <br />
          Contudo, a vida não me encaminhou logo para esta área, tendo iniciado
          o meu percurso profissional na área da saúde. Sou licenciada em
          Fisioterapia, exercendo esta profissão desde 2013.
          ...
          que me vi envolvida,uma vez que fui responsável por toda a escolha de
          materiais e disposição do espaço. <br />
          ...
          com que surgisse a ideia e vontade para mudar de rumo, tendo começado
          a pensar em procurar formação nesta área, contando com todo o apoio de
          familiares e amigos (sobretudo do marido que é engenheiro civil)!{" "}
          <br />
          ...
          anos, senti que era então altura de arriscar e iniciar um projeto que
          realmente me realizasse e fizesse feliz! Foi aí que me despedi do meu
          emprego a full time e criei este meu Chalet, que tem sido um desafio e
          aprendizagem constantes!"
        </p>

        <p className="font-text padding-top-element padding-bottom-section">
