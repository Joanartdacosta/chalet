...
import projectStyles from "./projectsGallery.module.css";

export default function () {
  return (
    <div>
      <div id={"complementar"} className={projectStyles.galleryMasonry}>
      ...
      <div id={"online"} className={projectStyles.galleryMasonry}>
